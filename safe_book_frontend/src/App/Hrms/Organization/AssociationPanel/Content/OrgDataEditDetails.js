      ...
      <div>
        ...
        <form id="orgEdit" onSubmit={handleSubmit}>
          <div>
            ...
            <div >
              <input className="orgEditInput" type="text" id="orgName" value={name} onChange={ (e) => setName(e.target.value) }>
          ...
          <div>
            ...
            <div>
              <input className="orgEditInput" type="text" id="orgAdress" value={adress} onChange={(e) => setAdress(e.target.value)}>
                {}
              </input>
            </div>
          </div>
          <div>
            ...
            <div>
              <input className="orgEditInput" type="text" id="KRS" value={krs} onChange={(e) => setKrs(e.target.value)}>
                {}
              </input>
            </div>
          </div>
          <div>
            ...
            <div>
              <input className="orgEditInput" type="text" id="REGON" value={regon} onChange={(e) => setRegon(e.target.value)}>
                {}
              </input>
            </div>
          </div>
          <div>
            ...
            <div>
              <input className="orgEditInput" type="text" id="NIP" value={nip} onChange={(e) => setNip(e.target.value)}>
          ...
          <div>
            ...
            <div>
              <input className="orgEditInput" type="text" id="orgBankAccount" value={bankAccountNumber} onChange={(e) => setBankAccountNumber(e.target.value)}>
                {}
              </input>
            </div>
          </div>
